                ...
                <Card className="bg-card border-border hover:border-primary/40 transition-all group overflow-hidden h-full flex flex-col">
                  {post.video_url ? (
                    <div className="aspect-video overflow-hidden bg-black flex items-center justify-center relative">
                      {post.thumbnail_url ? (
                        <>
                          <img src={post.thumbnail_url} alt={post.title} className="w-full h-full object-cover opacity-60 group-hover:scale-105 transition-transform duration-300" />
...
export const BlogPostPage: React.FC = () => {
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-8">
      ...
      {post.video_url ? (
        <div className="aspect-video overflow-hidden rounded bg-black mb-6">
