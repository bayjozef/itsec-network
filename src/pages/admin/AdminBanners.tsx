            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div className="grid grid-cols-2 gap-2">
                <div>
                  ...
                  <Input type="color" value={selected.title_color ?? '#ffffff'} onChange={e => setField('title_color', e.target.value)} className="bg-muted border-border h-9 w-full p-1" />
                </div>
                <div>
                  <label className="text-xs text-muted-foreground mb-1 block">Size (px)</label>
                  <Input type="text" value={selected.title_size ?? ''} onChange={e => setField('title_size', e.target.value)} className="bg-muted border-border h-9 text-sm" placeholder="e.g. 48" />
                </div>
              </div>
            </div>
            <div className="grid grid-cols-2 gap-3">
              ...
              <div className="grid grid-cols-2 gap-2">
                <div>
                  <label className="text-xs text-muted-foreground mb-1 block">Color</label>
                  <Input type="color" value={selected.subtitle_color ?? '#d1d5db'} onChange={e => setField('subtitle_color', e.target.value)} className="bg-muted border-border h-9 w-full p-1" />
                </div>
                <div>
                  <label className="text-xs text-muted-foreground mb-1 block">Size (px)</label>
                  <Input type="text" value={selected.subtitle_size ?? ''} onChange={e => setField('subtitle_size', e.target.value)} className="bg-muted border-border h-9 text-sm" placeholder="e.g. 18" />
                </div>
              </div>
            </div>
            <ImageUpload
