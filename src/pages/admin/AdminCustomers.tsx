...
const ROLE_COLORS: Record<string, string> = {
  ...
  distributor_mod: 'bg-teal-500/10 text-teal-400 border-teal-500/20',
...
const ROLE_LABELS: Record<string, { az: string; en: string }> = {
  ...
  seller:      { az: 'Satıcı',     en: 'Seller' },
  dealer:      { az: 'Topdancı',  en: 'Dealer' },
  distributor: { az: 'Diler',     en: 'Distributor' },
  distributor_mod: { az: 'Distributor Mod', en: 'Distributor Mod' },
                    ...
                    <tr key={p.id} className="border-b border-border/50 hover:bg-muted/20 transition-colors">
                      ...
                      <td className="px-4 py-3">
                        <div className="flex items-center gap-1">
                          ...
                          {/* Full role editor — only for admins */}
                          {profile?.role === 'admin' && (
                            <Button
                              variant="ghost"
                              size="icon"
              ...
              <div className="space-y-2">
                ...
                <Select value={editRole} onValueChange={setEditRole}>
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="distributor_mod">🛠 Distributor Mod</SelectItem>
                    <SelectItem value="dealer">🏪 Topdancı / Dealer (15%)</SelectItem>
                    <SelectItem value="seller">💼 Satıcı / Seller</SelectItem>
